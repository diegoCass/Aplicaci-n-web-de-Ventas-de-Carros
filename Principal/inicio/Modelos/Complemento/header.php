...
<body>
    <header>
        <div class="container-fluid">
            <div class="navb-logo">
                <img src="./Complemento/img/logo.png" alt="Logo">
            </div>
            <div class="navb-items d-none d-xl-flex">
                ...
                <div class="item-button">
                    <a href="/RAMHER/Principal/login.php" style="font-size: 15px;" type="button"><img src="./Complemento/img/usuario.png" width="30%" style="padding-right: 6%;" alt="">Mi cuenta</a>
                </div>
            </div>
            <div class="menu1">
